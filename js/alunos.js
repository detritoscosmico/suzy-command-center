(function () {
  ...
  function collectAdditional() {
    ...
    const valuation = SuzyValuationCore.normalizeState(readJson(KEYS.valuation, {}));
    return {
      ...
      ethics: ethics.passed ? 1 : 0, statistics: statistics.passed ? 1 : 0, economics: economics.passed ? 1 : 0, financials: financials.passed ? 1 : 0, valuation: valuation.passed ? 1 : 0
    };
  }
